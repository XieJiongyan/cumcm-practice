...
theta_range = [77.48042301619374, 81.53641554438047];
varphi_range = [87.55968743835396,112.2717950327316];
start_place = [104 + 55 / 60, 78 + 4/60];
end_place = [93, 80 + 26/60];
...
contourf(avi');
colorbar
fid = fopen('totalsolve/totalsolve/avi7.txt', 'w');
fprintf(fid, '%d %d \n ', x_size, y_size);
