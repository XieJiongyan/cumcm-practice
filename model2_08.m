...
theta_range = [73.83663361950852, 82.96123349902493];
varphi_range = [43.78692080784957,100.2932384348307];
start_place = [93, 80 + 26/60];
end_place = [58 + 48 / 60, 76 + 14/60];
...
contourf(avi');
colorbar
fid = fopen('totalsolve/totalsolve/avi8.txt', 'w');
fprintf(fid, '%d %d \n ', x_size, y_size);
