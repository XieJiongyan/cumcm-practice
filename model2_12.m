...
theta_range = [63.05737333896259, 86.76413253721181];
varphi_range = [121.0056328823539, 252.8721944511011];
start_place = [167 + 8 / 60, 85 + 57/60];
end_place = [180 + 10.5, 66 + 10 / 60];
...
contourf(avi');
colorbar
fid = fopen('totalsolve/totalsolve/avi12.txt', 'w');
fprintf(fid, '%d %d \n ', x_size, y_size);
